...
fpath=("${0:A:h}/modules/completion/src" $fpath)
...
if (( $#_compfile_in_20_min )); then
  compinit -i -C -d $_comp_file
else
  compinit -i -d $_comp_file
fi
unset _comp_file
unset _compfile_in_20_min
...
zstyle -a ':zconf:module:completion:*:hosts' etc-host-ignores '_etc_host_ignores'
